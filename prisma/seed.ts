...
async function main() {
    ...
    const scholarships = await Promise.all([
        ...
        // ============================================
        prisma.scholarship.create({ data: { scholarshipName: 'Private Education Assistance for Basic Education (PAEB) (GS/JHS)', sponsor: 'Private Education Assistance Committee', type: 'PAEB', source: 'EXTERNAL', eligibleGradeLevels: 'GRADE_SCHOOL,JUNIOR_HIGH', amount: new Prisma.Decimal(15000), requirements: 'Minimum GWA of 1.5', status: 'Active' } }),
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'Education Service Contracting (ESC) (JHS)', sponsor: 'Department of Education', type: 'ESC', source: 'EXTERNAL', eligibleGradeLevels: 'JUNIOR_HIGH', amount: new Prisma.Decimal(12000), requirements: 'ESC voucher holder', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'Local Government Unit (LGU) (JHS/SHS)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'JUNIOR_HIGH,SENIOR_HIGH', amount: new Prisma.Decimal(10000), requirements: 'Resident of the city/municipality', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'Local Government Unit (LGU) (SHS)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'SENIOR_HIGH', amount: new Prisma.Decimal(12000), requirements: 'Resident of the city/municipality', status: 'Active' } }),
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'Tertiary Education Subsidy (TES)', sponsor: 'Commission on Higher Education', type: 'TES', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(20000), requirements: 'Qualified TES applicant', status: 'Active' } }),
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'CHED Student Financial Assistance Program (StuFAPs)', sponsor: 'Commission on Higher Education', type: 'STUFAPS', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(25000), requirements: 'CHED StuFAPs qualified', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'CHED Merit Scholarship Program (CMSP)', sponsor: 'CMSP Foundation', type: 'CMSP', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(15000), requirements: 'Academic merit and leadership', status: 'Active' } }),
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'Confederation of School Associations, Inc. (COSCHO)', sponsor: 'COSCHO Foundation', type: 'COSCHO', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(12000), requirements: 'Financial need and academic standing', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'Tulong Dunong Program (TDP)', sponsor: 'DILG Tulong Dunong Program', type: 'TULONG_DUNONG', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(22000), requirements: 'Financial need and academic merit', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'Local Government Unit (LGU) (HIED)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(15000), requirements: 'Resident of the city/municipality', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'CHED CSP (Commission on Higher Education Student Program) Scholars', sponsor: 'Commission on Higher Education', type: 'CHED_CSP', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(30000), requirements: 'CHED CSP qualified student', status: 'Active' } }),
        prisma.scholarship.create({ data: { scholarshipName: 'University Association of Quezon City Technological Educational Association (UAQTEA) (DIPLOMA PROGRAM)', sponsor: 'UAQTEA Foundation', type: 'UAQTEA', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(18000), requirements: 'Diploma program student', status: 'Active' } }),
    ]);
    ...
    await Promise.all([
        // College - percentSubsidy calculated as (amountSubsidy / totalFees) * 100
        prisma.studentFees.create({ data: { studentId: students[0].id, tuitionFee: new Prisma.Decimal(35000), otherFee: new Prisma.Decimal(5000), miscellaneousFee: new Prisma.Decimal(3000), laboratoryFee: new Prisma.Decimal(7000), amountSubsidy: new Prisma.Decimal(4500), percentSubsidy: new Prisma.Decimal(9), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[1].id, tuitionFee: new Prisma.Decimal(30000), otherFee: new Prisma.Decimal(5000), miscellaneousFee: new Prisma.Decimal(4000), laboratoryFee: new Prisma.Decimal(6000), amountSubsidy: new Prisma.Decimal(5000), percentSubsidy: new Prisma.Decimal(11.11), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[2].id, tuitionFee: new Prisma.Decimal(32000), otherFee: new Prisma.Decimal(6000), miscellaneousFee: new Prisma.Decimal(3000), laboratoryFee: new Prisma.Decimal(7000), amountSubsidy: new Prisma.Decimal(4800), percentSubsidy: new Prisma.Decimal(10), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[3].id, tuitionFee: new Prisma.Decimal(28000), otherFee: new Prisma.Decimal(4000), miscellaneousFee: new Prisma.Decimal(3000), laboratoryFee: new Prisma.Decimal(5000), amountSubsidy: new Prisma.Decimal(4000), percentSubsidy: new Prisma.Decimal(10), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[4].id, tuitionFee: new Prisma.Decimal(30000), otherFee: new Prisma.Decimal(4000), miscellaneousFee: new Prisma.Decimal(3000), laboratoryFee: new Prisma.Decimal(5000), amountSubsidy: new Prisma.Decimal(4500), percentSubsidy: new Prisma.Decimal(10.71), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        // Senior High
        prisma.studentFees.create({ data: { studentId: students[5].id, tuitionFee: new Prisma.Decimal(18000), otherFee: new Prisma.Decimal(3000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(2000), amountSubsidy: new Prisma.Decimal(4000), percentSubsidy: new Prisma.Decimal(16), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[6].id, tuitionFee: new Prisma.Decimal(18000), otherFee: new Prisma.Decimal(3000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(2000), amountSubsidy: new Prisma.Decimal(4200), percentSubsidy: new Prisma.Decimal(16.8), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[7].id, tuitionFee: new Prisma.Decimal(18000), otherFee: new Prisma.Decimal(3000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(2000), amountSubsidy: new Prisma.Decimal(4000), percentSubsidy: new Prisma.Decimal(16), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        // Junior High
        prisma.studentFees.create({ data: { studentId: students[8].id, tuitionFee: new Prisma.Decimal(15000), otherFee: new Prisma.Decimal(2000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(1000), amountSubsidy: new Prisma.Decimal(4500), percentSubsidy: new Prisma.Decimal(22.5), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[9].id, tuitionFee: new Prisma.Decimal(15000), otherFee: new Prisma.Decimal(2000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(1000), amountSubsidy: new Prisma.Decimal(4500), percentSubsidy: new Prisma.Decimal(22.5), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        prisma.studentFees.create({ data: { studentId: students[10].id, tuitionFee: new Prisma.Decimal(15000), otherFee: new Prisma.Decimal(2000), miscellaneousFee: new Prisma.Decimal(2000), laboratoryFee: new Prisma.Decimal(1000), amountSubsidy: new Prisma.Decimal(4500), percentSubsidy: new Prisma.Decimal(22.5), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
        // Grade School
        prisma.studentFees.create({ data: { studentId: students[11].id, tuitionFee: new Prisma.Decimal(12000), otherFee: new Prisma.Decimal(1000), miscellaneousFee: new Prisma.Decimal(1500), laboratoryFee: new Prisma.Decimal(500), amountSubsidy: new Prisma.Decimal(4000), percentSubsidy: new Prisma.Decimal(26.67), term: '1st Semester 2025-2026', academicYear: '2025-2026' } }),
