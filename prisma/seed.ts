...
async function main() {
    ...
    const scholarships = await Promise.all([
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'ESC (JHS)', sponsor: 'Department of Education', type: 'ESC', source: 'EXTERNAL', eligibleGradeLevels: 'JUNIOR_HIGH', amount: new Prisma.Decimal(12000), requirements: 'ESC voucher holder', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'LGU (JHS/SHS)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'JUNIOR_HIGH,SENIOR_HIGH', amount: new Prisma.Decimal(10000), requirements: 'Resident of the city/municipality', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'LGU (SHS)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'SENIOR_HIGH', amount: new Prisma.Decimal(12000), requirements: 'Resident of the city/municipality', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        ...
        prisma.scholarship.create({ data: { scholarshipName: 'COSCHO', sponsor: 'COSCHO Foundation', type: 'COSCHO', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(12000), requirements: 'Financial need and academic standing', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'Tulong Dunong', sponsor: 'DILG Tulong Dunong Program', type: 'TULONG_DUNONG', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(22000), requirements: 'Financial need and academic merit', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'LGU (HIED)', sponsor: 'Local Government Unit', type: 'LGU', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(15000), requirements: 'Resident of the city/municipality', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'CHED-CSP Scholars', sponsor: 'Commission on Higher Education', type: 'CHED_CSP', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(30000), requirements: 'CHED CSP qualified student', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
        prisma.scholarship.create({ data: { scholarshipName: 'UAQTEA (DIPLOMA PROGRAM)', sponsor: 'UAQTEA Foundation', type: 'UAQTEA', source: 'EXTERNAL', eligibleGradeLevels: 'COLLEGE', amount: new Prisma.Decimal(18000), requirements: 'Diploma program student', status: 'Active', startDate: new Date('2025-06-01'), endDate: new Date('2026-05-31') } }),
    ]);
