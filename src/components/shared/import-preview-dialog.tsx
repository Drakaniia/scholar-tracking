    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Review the parsed data before importing. {data.invalid} out of {data.total} rows have
            errors.
          </DialogDescription>
        </DialogHeader>
                    ...
                    <div key={idx} className="rounded-lg bg-red-50 border border-red-200 p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-red-700 mt-1">{error.errors.join(', ')}</div>
        ...
        <DialogFooter>
          ...
          <Button onClick={onConfirm} disabled={data.valid === 0 || isLoading}>
