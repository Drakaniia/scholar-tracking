...
export function ScholarshipChart({
    ...
    return (
        <Card className="col-span-full lg:col-span-2 shadow-sm border-gray-200 dark:border-gray-800">
            <CardHeader>
                            ...
                            <Tooltip
                                content={({ active, payload, label }) => {
                                    if (active && payload && payload.length) {
                                        return (
                                            <div className="rounded-lg border bg-card p-3 shadow-lg border-gray-200 dark:border-gray-800 min-w-[180px]">
