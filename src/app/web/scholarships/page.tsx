            ...
            <Card className="mb-6">
                <CardContent className="p-4">
                    <div className="flex flex-col gap-4 sm:flex-row">
                        ...
                        <Select value={showApplied ? 'applied' : 'available'} onValueChange={(v) => setShowApplied(v === 'applied')}>
                            <SelectTrigger className="w-full sm:w-48">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {selectedScholarship?.name} - {formatCurrency(selectedScholarship?.amount || 0)}
                        </DialogDescription>
                    </DialogHeader>
