...
const COLUMN_MAPPINGS = {
    ...
    lastName: ['lastname', 'last_name', 'lname', 'last', 'surname', 'familyname', 'family_name', 'family'],
    middleInitial: ['middleinitial', 'middle_initial', 'mi', 'middleinitial', 'middlename', 'middle_name'],
    ...
    status: ['status', 'studentstatus', 'student_status', 'enrollmentstatus', 'enrollment_status', 'state'],
...
export async function POST(req: NextRequest) {
    try {
        ...
        const finalValidStudents = validStudents.filter((_, index) => 
