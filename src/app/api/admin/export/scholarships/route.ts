...
// GET /api/admin/export/scholarships - Export scholarships to PDF
export async function GET(request: NextRequest) {
  try {
    ...
    doc.text(
      `Total Programs: ${scholarships.length} | Active: ${activeCount} | Total Amount: ₱${totalAmount.toLocaleString()}`,
      14,
      38
    );
