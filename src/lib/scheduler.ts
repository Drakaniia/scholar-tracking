...
class SchedulerService {
   ...
   */
  public scheduleOneTimeTask(delayMs: number, task: () => Promise<void>, name: string): NodeJS.Timeout {
   ...
   */
  public scheduleRecurringTask(intervalMs: number, task: () => Promise<void>, name: string): NodeJS.Timeout {
